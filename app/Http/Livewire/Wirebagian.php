...
class Wirebagian extends Component
{
    ...
    {
        return view('livewire.wirebagian',[
    ...
    public function selectemItem($itemId, $action)
    {
        ...
        if($action == 'delete'){
            ...
            $data = Bagian::find($this->selectedItem);
            $this->name = $data->name;
        }
    ...
    public function save()
    {
        ...
        $this->selectedItem ? $save = Bagian::find($this->selectedItem)->update($data) : $save = Bagian::create($data);
    ...
    {
        $delete = Bagian::destroy($this->selectedItem);
