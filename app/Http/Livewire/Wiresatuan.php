...
class Wiresatuan extends Component
{
    ...
    {
        return view('livewire.wiresatuan',[
    ...
    public function selectemItem($itemId, $action)
    {
        ...
        if($action == 'delete'){
            ...
            $data = Satuan::find($this->selectedItem);
            $this->name = $data->name;
        }
    ...
    public function save()
    {
        ...
        $this->selectedItem ? $save = Satuan::find($this->selectedItem)->update($data) : $save = Satuan::create($data);
    ...
    {
        $delete = Satuan::destroy($this->selectedItem);
